...
The plan should be executed in small commits. Do not commit the user's existing `prd.md` changes unless the user explicitly asks.
...
- Create/modify: `web/**`
- Preserve: `prd.md`
- Preserve: `techstack-draft.md`
- Preserve: `docs/superpowers/specs/2026-05-28-wellness-center-initialization-design.md`
- Preserve: `docs/superpowers/plans/2026-05-28-wellness-center-initialization.md`
...
```text
 M prd.md
?? docs/superpowers/plans/2026-05-28-wellness-center-initialization.md
```

There may also be existing committed docs and `.gitignore`. Do not stage `prd.md`.
...
```powershell
git checkout -- docs/superpowers/specs/2026-05-28-wellness-center-initialization-design.md
git checkout -- docs/superpowers/plans/2026-05-28-wellness-center-initialization.md
```
...
```powershell
Test-Path docs\superpowers\specs\2026-05-28-wellness-center-initialization-design.md
Test-Path docs\superpowers\plans\2026-05-28-wellness-center-initialization.md
```
...
If `prd.md` appears staged, unstage it first:

```powershell
git restore --staged prd.md
```
...
```powershell
git grep -n -F -e "BMW" -e "car-configurator" -e "merch-shop" -e "route-service" -- ':!docs/superpowers/specs/2026-05-28-wellness-center-initialization-design.md' ':!docs/superpowers/plans/2026-05-28-wellness-center-initialization.md'
```
